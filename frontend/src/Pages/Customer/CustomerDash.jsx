...
const CustomerDash = () => {
  ...
  // Generate particle positions ONCE (prevents layout changes on rerender)
              ...
              <div className="relative glass-strong rounded-3xl p-8 border border-amber-500/20 shadow-2xl h-full overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-2xl font-black text-white">Your Rewards</h3>
                  </div>

                  <div className="space-y-4">
                    <div className="glass-strong p-6 rounded-2xl border border-yellow-500/30 animate-pulse-glow">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-white font-bold text-lg">Free Coffee</p>
                            <p className="text-yellow-400 text-sm">Available now!</p>
                          </div>
                        </div>
                        <button className="bg-gradient-to-r from-yellow-500 to-amber-600 text-white font-bold px-6 py-2 rounded-xl hover:scale-110 transition-transform">
                          Claim
                        </button>
                      </div>
                      <p className="text-amber-200/70 text-sm">Redeem for any drink up to LKR 500</p>
                    </div>

                    <div className="glass p-4 rounded-xl border border-amber-500/20">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-amber-200 font-semibold">Next Reward</p>
                          <p className="text-amber-300/60 text-sm">60 points away</p>
                        </div>
                        <div className="text-right">
                          <p className="text-2xl font-black text-white">240/300</p>
                          <div className="w-24 h-2 bg-stone-800 rounded-full mt-2 overflow-hidden">
                            <div className="h-full w-4/5 bg-gradient-to-r from-amber-500 to-orange-600 rounded-full"></div>
                          </div>
                        </div>
                      </div>
                    </div>
